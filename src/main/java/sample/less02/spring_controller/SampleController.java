...
//	//웹브라우저: http://localhost:8080/mypro00/sample/2
	...
	@GetMapping(value = "/ex022List")//값이 전달됨
	...
	@GetMapping(value = "/ex055List")//JSP 파일까지 값 전달이 않됨
...
//	public void exUploadPost(MultipartFile[] myFiles, SampleDTO dto) {//전송파일이 하나 이상일 경우
	public void exUploadPost(ArrayList<MultipartFile> myFiles, SampleDTO dto) {//전송파일이 하나 이상일 경우
...
//			try {
//				myFile.transferTo(saveFile); //파일이 서버에 저장
//			} catch (IllegalStateException e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			} catch (IOException e) {
