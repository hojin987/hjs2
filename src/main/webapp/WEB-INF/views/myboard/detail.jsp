...
<%-- <form role="form"  action="${contextPath}/myboard/register"
	...
	<div class="form-group">
	    ...
	    <input class="form-control" name="bmodDate" id="bmodDate"
	    	   value='<fmt:formatDate value="${myboard.bmodDate}" pattern="yyyy/MM/dd HH:mm:ss"/>' readonly="readonly">
	</div>
	
	<button type="button" class="btn btn-default" id="btnToModify">수정페이지로 이동</button>
